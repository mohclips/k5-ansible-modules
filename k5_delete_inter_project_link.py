...
DOCUMENTATION = '''
---
module: k5_delete_inter_project_link
short_description: Delete inter-project link on K5 in particular AZ
version_added: "1.0"
description:
    - K5 call to delete an inter-project network link in an AZ - the inter-project link is custom to K5 therefore there is no Openstack module. 
options:
   router_name:
     description:
...
EXAMPLES = '''
# Create deletes an inter-project link in an AZ
- k5_create_inter_project_link:
        state: present
        port_id: "30219335-2b1b-419a-9543-b47ed62a0935"
...
def main():
    ...
    module = AnsibleModule( argument_spec=dict(
        ...
        port_id = dict(required=True, default=None, type='str'),
